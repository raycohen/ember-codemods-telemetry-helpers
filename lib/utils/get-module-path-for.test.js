...
describe('getModulePathFor', () => {
  ...
  test('can determine the runtime module id for a specific on disk in-repo addon file in the app/ folder', () => {
    expect(
      getModulePathFor(
        '/User/whomever/some-app/lib/special-sauce/app/components/tangy-sauce.js',
        addonPaths,
        appPaths
      )
    ).toEqual('some-app/components/tangy-sauce');
  });
